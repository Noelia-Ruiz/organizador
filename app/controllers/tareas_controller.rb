class TareasController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tareas_path, status: :see_other, notice: "Tarea was successfully destroyed." }
  ...
  private
    ...
    def tarea_params
      params.require(:tarea).permit(:nombre, :descripcion, :fecha_vencimiento, :categoria_id)
    end
end
